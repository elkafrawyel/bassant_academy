...
class NotificationsService {
  ...
  static const String _channelName = 'Bassant Academy';
  ...
  Future<void> init() async {
    ...
    await _instance.getToken().then(
          (token) => Utils.logMessage('FIREBASE TOKEN : : $token'),
        );
    ...
    FirebaseMessaging.onMessageOpenedApp.listen(
      (RemoteMessage remoteMessage) {
        if (remoteMessage.notification != null) {
          Utils.logMessage('Background Notification Tapped.');
          _handleBackgroundRemoteMessage(remoteMessage);
        }
      },
    );
    ...
    FirebaseMessaging.onMessage.listen(
      (RemoteMessage remoteMessage) {
        Utils.logMessage('Got a Foreground Notification.');
        if (remoteMessage.notification != null) {
